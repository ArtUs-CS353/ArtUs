...
export default function BasicDatePicker({maxDate, minDate, handleSelection}) {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <DemoContainer components={['DatePicker']}>
        <DatePicker onChange={handleDateSelection} label="Date" maxDate={maxDate || undefined} minDate={minDate || undefined} />
      </DemoContainer>
