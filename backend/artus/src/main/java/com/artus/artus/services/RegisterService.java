...
public class RegisterService {
    ...
    public String registerEnthusiast(Enthusiast enthusiast){
        try {
            ...
            jdbcTemplate.update(insertUserSql,enthusiast.getUser_name(),enthusiast.getUser_surname(),3,enthusiast.getEmail(),hashedPassword,enthusiast.getContact_info());
    ...
    public String registerArtist(Artist artist){
        try {
            ...
            String hashedPassword = hashPasswordHelper.Hash();
            jdbcTemplate.update(insertUserSql,artist.getUser_name(),artist.getUser_surname(),3,artist.getEmail(),hashedPassword,artist.getContact_info());
