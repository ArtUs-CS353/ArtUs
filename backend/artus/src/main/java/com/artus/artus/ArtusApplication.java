...
public class ArtusApplication implements CommandLineRunner{
	...
	public void run(String... strings) throws Exception {
		...
		jdbcTemplate.execute("create table if not exists Notification(user_id int, notification_id int NOT NULL AUTO_INCREMENT, type varchar(50), content varchar(50), primary key (notification_id), foreign key (user_id) references User(user_id));");
