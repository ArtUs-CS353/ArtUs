...
public class ArtusApplication implements CommandLineRunner{
	...
	public void run(String... strings) throws Exception {
		...
		jdbcTemplate.execute("create table if not exists Event(user_id int, event_id int NOT NULL AUTO_INCREMENT, title varchar(50), meeting_link varchar(50), start_date datetime, end_date datetime, poster_URL varchar(50), status varchar(50), primary key (event_id),foreign key (user_id) references Artist (user_id));");
